                    ...
                    <div className="mx-auto max-w-xl bg-[#f2f2f7] p-8 text-center">
                        ...
                        <form className="mx-auto mb-4 max-w-sm text-left" name="wf-form-password" method="get">
                            <div className="mb-4 flex flex-col gap-y-2">
                                <label for="name-2" className="mb-1 font-medium">Your Name</label>
                                <input type="text" className="h-9 w-full bg-white px-3 py-6 text-sm text-[#333333]" placeholder="" required="" />
                            </div>
                            <div className="mb-4 flex flex-col gap-y-2">
                                <label for="name-2" className="mb-1 font-medium">Email Address</label>
                                <input type="text" className="h-9 w-full bg-white px-3 py-6 text-sm text-[#333333]" placeholder="" required="" />
                            </div>
                            <div className="mb-8 flex flex-col gap-y-2">
                                <label for="field-3" className="mb- font-medium">Project Brief</label>
